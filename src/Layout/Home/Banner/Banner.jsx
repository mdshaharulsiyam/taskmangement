...
const Banner = () => {
    return (
        <div className='bg-[url(https://i.ibb.co/9wpFX5f/d4eaf149-task-management.png)] px-2 py-10 bg-cover bg-no-repeat min-h-screen relative z-20'>
            ...
            <div className='container mx-auto z-20 text-yellow-400 grid md:grid-cols-2 gap-3 items-center justify-center min-h-screen'>
                <div>
                    ...
                    <Link to={'/dashboard/mytask'}><button className='bg-blue-600 mt-3'>Let’s Explore</button></Link>
                </div>
